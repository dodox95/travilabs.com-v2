  ...
  return (
    <div className="py-8">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-white animate-fade-in-down bg-white dark:bg-slate-950 text-[#333] dark:text-white">Our Offerings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {offers.map((offer, index) => (
            <div
              key={index}
              className={`bg-white dark:bg-slate-950 text-[#333] dark:text-white rounded-lg shadow p-6 flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 animate-fade-in-up delay-${index * 100}`}
            >
